...
export default function RegisterRequests() {
  ...
  useEffect(() => {
    async function getMerchant() {
      ...
      let response = await api.get('/api/request.details/' + idRequest);

      setCode_request(response.data.code_request);
      setForm_pay(response.data.form_pay);
      setType_invoice(response.data.type_invoice);
      setState_request(response.data.state_request);
    ...
    async function hendleSubmit() {
      ...
      if(code_request !== '' && form_pay !== '' && type_invoice !== '' & state_request !== '') {
          ...
          const response = await api.put('/api/request', data);
